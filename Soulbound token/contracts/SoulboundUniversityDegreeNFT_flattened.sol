...
// File: contracts/SoulboundUniversityDegreeNFT.sol
...
contract SoulboundUniversityDegreeNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    // This allows minting and burning, but not transfers between addresses
    if (from != address(0)) {
